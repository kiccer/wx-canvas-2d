// main
export const WxCanvas2d = require('./WxCanvas2d.js')

// series
export const Arc = require('./series/Arc.js')
...
// utils
export const Debugger = require('./utils/Debugger.js')
export const SaveToAlbum = require('./utils/SaveToAlbum.js')
